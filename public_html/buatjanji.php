...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$querycekdiri = "SELECT dp.psn_id, dp.psn_nama, dd.doc_id, dd.doc_nama, dd.doc_spesial,dj.harijanji FROM datapasien AS dp INNER JOIN datajanji AS dj ON dp.psn_id = dj.idpassien INNER JOIN datadokter AS dd ON dj.iddokter = dd.doc_id WHERE dp.psn_id='$idpasien';";
	...
	if( mysqli_num_rows($sqlcekdiri) > 0 ){
		$result = array("success"=> 2,"message"=> "Anda sudah punya janji pada minggu tersebut");
